...
# Summary
st.write("""
Experienced Technical Lead with expertise in cloud architecture, Atlassian tools, and full-stack development. Proven track record in leading technical teams, implementing cloud migrations, and managing large-scale organizational tools. Strong background in automation and process optimization with a focus on enterprise-level solutions.
""")
